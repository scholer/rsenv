...
def post_data(sequence, seq_name=None, proj_token=None):
    ...
    data = {
        'referer': "",      # <input type="hidden" name="referer" value="">
        ...
        # 'name': '0',        # Token, should be (pseudo) randomized like name=63ca7b3d-   # base64 ? 8 hex values + '-'
        ...
        # -----------------------------------
        'sequence': sequence,
        'name': proj_token or "".join(random.choice("1234567890abcdef") for i in range(8)) + '-',
        'username': seq_name or "rasmus01"
    }
