...
However, in the response, essentially what you are looking for is:
    QCZipDownload.ashx?SalesOrdNbr=4CNQKbS1zoIiXv94CD6nMA==     # Quality control link
      COADownload.ashx?SalesOrdNbr=4CNQKbS1zoIiXv94CD6nMA==     # Certificate of Analysis excel sheet
    /site/OrderStatus/OrderStatus/InvoiceDownload?salesOrdNbr=4CNQKbS1zoIiXv94CD6nMA=="     # Invoice

Full links:
    <a href="QCZipDownload.ashx?SalesOrdNbr=7FUU96RvhPAiXv94CD6nMA==">
